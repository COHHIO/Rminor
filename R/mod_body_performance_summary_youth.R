...
mod_body_performance_summary_youth_server <- function(id) {
  moduleServer(id, function(input, output, session) {
    ...
    output$ps_plot_2 <-
      plotly::renderPlotly({
        ...
        # Define goals for different project types
        goals <- list(
            "Emergency Shelter – Entry Exit" = 0.25,
            "PH – Rapid Re-Housing" = 0.83,
            "Transitional Housing" = 0.50,
    ...
    output$ps_plot_4 <-
      plotly::renderPlotly({
        ...
        # Define goals for different project types
        goals <- list(
          "Emergency Shelter – Entry Exit" = 0.10,
          "PH – Rapid Re-Housing" = 0.70,
          "Transitional Housing" = 0.60,
