...
mod_body_qpr_temp_permanent_housing_ui <- function(id){
  ns <- NS(id)
  mod_qpr_ui(id)
}
...
#'
#' @noRd 
mod_body_qpr_temp_permanent_housing_server <- function(id){
  moduleServer( id, mod_qpr_server(id, "Exits to Temporary or Permanent Housing"))
}
