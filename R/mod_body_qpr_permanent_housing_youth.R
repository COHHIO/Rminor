...
mod_body_qpr_permanent_housing_youth_ui <- function(id){
  ns <- NS(id)
  mod_qpr_ui(id)
}
...
#'
#' @noRd 
mod_body_qpr_permanent_housing_youth_server <- function(id){
  moduleServer( id, mod_qpr_server(id, "Youth Exits to Permanent Housing"))
}
